...
VALUES (2, 'title', 'description', 'thumb', 'cover', 20, '85 fakestreet', true, 1, 1, 'canada', 'edmonton','ab','fakepostalcode', true),
(3, 'title', 'description', 'thumb', 'cover', 20,'75 fakestreet', true, 1, 1, 'canada', 'edmonton', 'ab', 'fakepostalcode', true),
(1, 'title', 'description', 'thumb', 'cover', 20, '95 fakestreet', false, 1, 1, 'canada', 'edmonton', 'ab', 'fakepostalcode', true);
...
VALUES (1, 1, 2, 5, 'great place'), (2, 2, 1, 3, 'okayplace'), (3, 3, 3, 1, 'dont stay here');
